    ...
    <div className="space-y-6">
      ...
      {locations.length === 0 ? (
        <EmptyState
          ...
          description="Add a location to organise your vendors, clients, and assets by place."
          action={
            <Button onClick={() => navigate('/locations/new')}>
              <Plus className="h-4 w-4 mr-2" />
              New Location
                      ...
                      <TableRow>
                        <TableCell colSpan={6} className="text-center py-8">
                          <p className="text-muted-foreground">
                            {searchQuery ? `No matches for "${searchQuery}"` : 'No matches for the current filters'}
                          </p>
